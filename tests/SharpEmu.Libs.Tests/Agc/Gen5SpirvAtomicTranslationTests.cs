...
public sealed class Gen5SpirvAtomicTranslationTests
{
    ...
    {
        // BUFFER_ATOMIC_UMAX v1 and BUFFER_ATOMIC_CMPSWAP v[1:2],
        // both against the V# in s[0:3].
    ...
    [Fact]
    public void BufferAtomicInc_EmitsCompareExchangeLoopForClampSemantics()
    {
        // BUFFER_ATOMIC_INC wraps according to the source operand, which cannot be
        // represented by SPIR-V's operand-free OpAtomicIIncrement instruction.
        var opcodes = CompileCompute(

...
/// <summary>
/// Software implementations of the Intel SHA-extension operations used by
/// SHA-1 code when the host cannot execute SHA-NI directly.
/// </summary>
public static class Sha1InstructionEmulator
{
    ...
    public static Sha1Vector FourRounds(Sha1Vector destination, Sha1Vector source, byte function)
    {
        ...
        for (var round = 0; round < 4; round++)
        {
            ...
            uint next = unchecked(
                choose + BitOperations.RotateLeft(a, 5) + word + e + constant);
            e = d;
            d = c;

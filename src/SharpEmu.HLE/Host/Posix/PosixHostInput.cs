...
/// <see cref="PosixHostInput.SetSource(IPosixWindowInputSource)"/> once the
/// window exists. Until then (and with no window at all, e.g. headless runs)
/// every query reports neutral input.

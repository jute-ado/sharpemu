...
public sealed class Sha1InstructionEmulatorTests
{
    ...
    [Fact]
    public void MessageSchedule1MatchesIntelLaneSemantics()
    {
        Assert.Equal(
    ...
    [Fact]
    public void MessageSchedule2MatchesIntelLaneSemantics()
    {
        Assert.Equal(
    ...
    [Fact]
    public void NextEMatchesIntelLaneSemantics()
    {
        Assert.Equal(
    ...
    public void FourRoundsMatchesAllSha1Functions(
        byte function,
        uint lane0,
        uint lane1,
        uint lane2,

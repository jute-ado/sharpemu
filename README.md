...
This fork exists purely for research and education. 
Much of the development is AI-assisted and exploratory, 
with a strong TDD approach to catch regressions, validate behaviour, 
and keep generated code grounded in observable results.
